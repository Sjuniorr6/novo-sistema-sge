...
class paradaForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'transportador', 'placa_cavalo', 'foto_cavalo','foto_documento_cavalo', 'placa_carreta', 'foto_carreta','foto_carreta_documento', 
            'nome_motorista','cnh', 'previsao_de_saida', 'Horario_de_saida', 'inconformidade', 'descreva'
        ]
        widgets = {
